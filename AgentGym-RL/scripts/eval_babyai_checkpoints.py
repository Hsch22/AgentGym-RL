...
def main():
    ...
    parser.add_argument("--env-addr", default="http://127.0.0.1:36025")
    ...
    results_dir = run_dir / "eval_babyai_ckpt_sweep"
    ...
    if args.wandb_mode != "disabled":
        ...
        wandb_run = wandb.init(
            ...
            name=args.wandb_name or f"babyai_eval_{run_dir.name}_{datetime.utcnow().strftime('%Y%m%d_%H%M%S')}",
            config={
                "run_dir": str(run_dir),
